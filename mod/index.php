...
<head>
    ...
    <script>
        $(function() {
            ...
            $("#downloadHomepage").on("click", function() {
                downloadObj = {"version": "2.6"};
                $.post("https://notifly.zone/mod/updateDownloads.php", JSON.stringify(downloadObj));
            });
  ...
  <!-- Modal -->
  <div class="modal fade" id="versionsModal" tabindex="-1" role="dialog" aria-labelledby="versionsModalTitle" aria-hidden="true">
            ...
            <table class="table">
              ...
              <tbody>
                    <tr>
                        ...
                        <td>21/02/20</td>
                        <td>
                            <a href="#" data-container="body" data-toggle="popover" data-placement="right" data-content="Added staff support">
                                Notes
                            </a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>19/07/19</td>
                      <td>
                          <a href="#" data-container="body" data-toggle="popover" data-placement="right" data-content="Properly updated blitz quests">
                              Notes
                          </a>
                        </td>
                    </tr>
                    <tr>
                      ...
                      <td>21/06/19</td>
                      <td>
                          <a href="#" data-container="body" data-toggle="popover" data-placement="right" data-content="Updated speed uhc quests">
                              Notes
                          </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>14/05/19</td>
                        <td>
                            <a href="#" data-container="body" data-toggle="popover" data-placement="right" data-content="Updated blitz quests (-chaos, +chests)">
                                Notes
                            </a>
                          </td>
                    </tr>
                    <tr>
                      ...
                      <td>02/04/19</td>
                      <td>
                          <a href="#" data-container="body" data-toggle="popover" data-placement="right" data-content="Fixed arena brawl daily kills quest (10 kills -> 5 kills)">
                              Notes
                          </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>31/03/19</td>
                        <td>
                            <a href="#" data-container="body" data-toggle="popover" data-placement="right" data-content="Added new warlords 'All Star' weekly quest">
                                Notes
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>29/03/19</td>
                        <td>
                            <a href="#" data-container="body" data-toggle="popover" data-placement="right" data-content="First release.">
                              Notes
                            </a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>07/09/18</td>
                      <td>
                          <a href="#" data-container="body" data-toggle="popover" data-placement="right" data-content="Outdated version containing security flaw">
                              Notes
                          </a>
                      </td>
                    </tr>
          ...
          <main role="main" class="inner cover">
              ...
              <div class="modal-dialog" role="document" style="margin-top: 10px; margin-bottom: 10px;">
                  <div class="modal-content" style="border: none">
                      ...
                      <div class="modal-body">
                          <p class="lead" style="margin-bottom: 0px;">A 1.8.9 forge mod to make quest tracking easier. Type <mark>/q help</mark> in game for list of commands</p>
                          <hr>
                      ...
                      <div class="modal-footer">
                          ...
                          <p class="lead" style="margin-bottom:0px;">
                              <a href="versions/TheQuestingMod-2.6.jar" class="btn btn-lg btn-primary" id="downloadHomepage">Download <i class="fa fa-download"></i></a>
                          </p>
                      </div>
                  </div>
              </div>
